...
function setupPbjs() {
    ...
    const fakeSlot = { id: 'test' };
    fakeSlot.getSlotElementId = stub().returns(fakeSlot.id);
    global.pbjs.rp.requestBids = stub().callsFake(requestBidsConfig => requestBidsConfig.callback([fakeSlot]));
