module.exports = (function(e) {
        ...
        t.default = function(e) {
            return function(t) {
                return i.default.createElement(o.default.Consumer, null, function(r) {
                    var o = r.activate,
                        a = r.active;
                    return i.default.createElement(e, n({}, t, { activate: o, active: a }));
                });
            };
        };
    },
                        ...
                        (T.prototype = {
                            ...
                            finish: function(e) {
                                for (var t = this.tryEntries.length - 1; t >= 0; --t) {
                                    ...
                                    if (r.finallyLoc === e) return this.complete(r.completion, r.afterLoc), q(r), y;
                                }
                            },
                            catch: function(e) {
                                for (var t = this.tryEntries.length - 1; t >= 0; --t) {
                        ...
                        (o._invoke = (function(e, t, r) {
                            ...
                            return function(i, o) {
                                ...
                                for (r.method = i, r.arg = o; ; ) {
                                    ...
                                    var s = P(e, t, r);
                                    if ('normal' === s.type) {
                                        if (((n = r.done ? v : p), s.arg === y)) continue;
                ...
                function x(e, t) {
                    ...
                    if (r === n) {
                        if (((t.delegate = null), 'throw' === t.method)) {
                            if (
                                e.iterator.return &&
                                ((t.method = 'return'), (t.arg = n), x(e, t), 'throw' === t.method)
                            )
                                return y;
                            (t.method = 'throw'),
                ...
                n(t, [
                    {
                        ...
                        value: function() {
                            this.props.active && this.advertising.setup();
                        }
                    },
                    {
                    ...
                    },
                    {
                        key: 'render',
                        value: function() {
                            (this.advertising = new a.default(this.props.config, this.props.plugins)),
                                (this.activate = this.advertising.activate.bind(this.advertising));
                            var e = { activate: this.activate, active: this.props.active };
                            return o.default.createElement(u.default.Provider, { value: e }, this.props.children);
                        }
                    }
                ]),
                t
    ...
    function(e, t, r) {
        ...
        var a = Symbol('define GTP size mappings (private method)'),
            ...
            v = Symbol('call DFP slots in setup (private method)'),
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    this.config.slots.forEach(function(t) {
                                        ...
                                        try {
                                            for (
                                                var y, m = Object.entries(s)[Symbol.iterator]();
                                                !(p = (y = m.next()).done);
                                                p = !0
                                            ) {
                                                var g = y.value,
    ...
    function(e, t, r) {
        ...
        (s.defaultProps = { customEventHandlers: {}, active: !0 }), (t.default = (0, a.default)(s));
    }
]);
